...
public class SupportLoadingView2 extends ImageView
{
	private Context context;
	private int color;

	public SupportLoadingView2(final Context context, int icon, int color)
	{
		super(context);
		...
		setImageDrawable(
			SupportDrawable.tint(
				SupportDrawable.fromResource(icon, 0.5f),
				color));
	...
	public RelativeLayout getWrapped(String message)
	{
		...
		RelativeLayout rel_layout = new RelativeLayout(context);
